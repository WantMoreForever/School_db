...
<div class="mb-3">
    <input name="email" type="email" class="form-control" placeholder="邮箱" required inputmode="email" pattern="<?= h(admin_school_email_pattern()) ?>" title="<?= h(admin_school_email_title()) ?>" value="<?= h((string) ($row['email'] ?? '')) ?>">
</div>
<div class="mb-3">
    <?php if ($isEdit): ?>
