...
-- - 如需演示环境，请改用 tests/sql/demo_seed.sql
-- - 本文件仅用于 QA、回归和业务规则验证，不参与答辩演示链路
...
VALUES
    (9301, 'Spring', 2026, 9201, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 40),
    (9302, 'Spring', 2026, 9202, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 35),
    (9303, 'Spring', 2026, 9203, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 30),
    (9304, 'Spring', 2026, 9204, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 30),
    (9305, 'Spring', 2026, 9205, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 40),
    (9306, 'Spring', 2026, 9206, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 2),
    (9307, 'Spring', 2026, 9207, '2026-01-05 08:00:00', '2026-07-01 23:59:59', 25)
ON DUPLICATE KEY UPDATE
...
VALUES
    ...
    -- [冲突样例] 与 9401 同为 time_slot=1，供学生选课冲突验证
    (9402, 9302, 1, '08:00:00', '09:40:00', 9502, 1, 16),
    -- [正常样例] AI 导论
    (9403, 9303, 2, '10:00:00', '11:40:00', 9503, 1, 16),
    -- [冲突样例] 与 9401 同教室、同 time_slot=1，供教室冲突验证
    (9404, 9304, 1, '08:00:00', '09:40:00', 9501, 1, 16),
    -- [冲突样例] 与 9403 为同一教师且同 time_slot=2，供教师课表冲突验证
    (9405, 9305, 2, '10:00:00', '11:40:00', 9504, 1, 16),
    -- [正常样例] 软件测试，小班容量课程
    (9406, 9306, 3, '13:30:00', '15:10:00', 9505, 1, 16),
    -- [正常样例] 普通开放课程
    (9407, 9307, 4, '15:30:00', '17:10:00', 9502, 1, 16)
ON DUPLICATE KEY UPDATE
...
VALUES
    (900201, 9301, NULL, '2026-01-06 09:00:00'),
    (900202, 9301, NULL, '2026-01-06 09:05:00'),
    (900203, 9303, NULL, '2026-01-06 09:10:00'),
    (900204, 9304, NULL, '2026-01-06 09:15:00'),
    (900207, 9306, NULL, '2026-01-06 09:20:00'),
    (900208, 9306, NULL, '2026-01-06 09:25:00'),
    (900207, 9301, NULL, '2026-01-06 09:30:00'),
    (900208, 9301, NULL, '2026-01-06 09:35:00'),
    (900209, 9307, NULL, '2026-01-06 09:40:00')
ON DUPLICATE KEY UPDATE
    grade = VALUES(grade),
...
VALUES
    (9701, 900101, 900201, 9301, '2026-06-20', 'final', 0.00),
    (9702, 900101, 900202, 9301, '2026-06-20', 'final', 59.00),
    (9703, 900101, 900207, 9301, '2026-06-20', 'final', 60.00),
    (9704, 900101, 900208, 9301, '2026-06-20', 'final', 100.00)
ON DUPLICATE KEY UPDATE
...
VALUES
    (9601, 900001, '【测试】全校系统维护公告', '面向所有用户的全体公告。', 'published', 1, '2026-01-20 08:00:00', '2026-01-20 08:00:00', '2026-01-20 08:00:00'),
    (9602, 900001, '【测试】学生事务提醒', '仅学生端应可见。', 'published', 0, '2026-01-21 09:00:00', '2026-01-21 09:00:00', '2026-01-21 09:00:00'),
    (9603, 900001, '【测试】教师排课提醒', '仅教师端应可见。', 'published', 0, '2026-01-22 10:00:00', '2026-01-22 10:00:00', '2026-01-22 10:00:00'),
    (9604, 900001, '【测试】人工智能专业定向公告', '仅 major_id=9102 的学生应可见。', 'published', 0, '2026-01-23 11:00:00', '2026-01-23 11:00:00', '2026-01-23 11:00:00'),
    (9605, 900101, '【测试】数据结构班级通知', '仅已选 9301 班级的学生与任课教师应可见。', 'published', 0, '2026-01-24 12:00:00', '2026-01-24 12:00:00', '2026-01-24 12:00:00'),
    (9606, 900001, '【测试】草稿公告', '这是一条未发布公告，用于验证草稿不可见。', 'draft', 0, NULL, '2026-01-25 13:00:00', '2026-01-25 13:00:00'),
    (9607, 900001, '【测试】AI 导论班级公告', '仅已选 9303 的学生与任课教师应可见。', 'published', 0, '2026-01-26 14:00:00', '2026-01-26 14:00:00', '2026-01-26 14:00:00')
ON DUPLICATE KEY UPDATE
