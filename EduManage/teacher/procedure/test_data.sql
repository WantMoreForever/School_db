...
(2, '20210001', '大三', 2021, 1),
(3, '20210002', '大三', 2021, 2),
(4, '20220001', '大二', 2022, 1),
(5, '20220002', '大二', 2022, 3),
(6, '20220003', '大二', 2022, 1);
...
-- 11. 课程表
-- ============================================================
-- 插入示例教室（用于旧测试数据映射）：building / room_number
...
-- ============================================================
-- 11. 课程表（使用 classroom_id 替代文本 location）
-- ============================================================
INSERT INTO schedule (section_id, day_of_week, start_time, end_time, classroom_id, week_start, week_end) VALUES
-- 数据结构（section 1）：周一、周三 08:00-09:40
(1, 1, '08:00:00', '09:40:00', 1, 1, 16),
(1, 3, '08:00:00', '09:40:00', 1, 1, 16),
-- 数据库原理（section 2）：周二、周四 10:00-11:40
(2, 2, '10:00:00', '11:40:00', 2, 1, 16),
(2, 4, '10:00:00', '11:40:00', 2, 1, 16),
-- 操作系统（section 3）：周五 14:00-16:40
(3, 5, '14:00:00', '16:40:00', 3, 1, 16);
