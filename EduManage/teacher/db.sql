...
CREATE TABLE `department`  (
  ...
  `dept_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '院系代码',
...
CREATE TABLE `student`  (
  ...
  `student_no` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '学号（8位数字，唯一）',
