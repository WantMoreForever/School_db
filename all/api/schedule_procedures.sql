...
BEGIN
    ...
    GROUP BY s.schedule_id, s.section_id, s.day_of_week, s.start_time,
             s.end_time, s.location, s.week_start, s.week_end,
             c.course_id, c.name, sec.semester, sec.year, u.name
    ORDER BY s.year DESC, FIELD(s.semester, 'Fall', 'Spring'), s.day_of_week, s.start_time;
END$$
...
BEGIN
    ...
    ELSE
        SET v_room_conflict = fn_check_room_conflict(
            p_location, p_day_of_week, p_start_time, p_end_time, p_schedule_id
        );
...
BEGIN
    ...
    ELSE
        SET v_room_conflict = fn_check_room_conflict(
            p_location, p_day_of_week, p_start_time, p_end_time, 0
        );
        ...
        ELSE
            ...
            ELSE
                ...
                VALUES (p_section_id, p_day_of_week, p_start_time, p_end_time, p_location, p_week_start, p_week_end);
...
BEGIN
    ...
    GROUP BY
        ...
        s.location, s.week_start, s.week_end,
