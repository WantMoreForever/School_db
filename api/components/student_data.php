...
// 用绝对路径做 file_exists 判断
$uploadDir  = $_SERVER['DOCUMENT_ROOT'] . '/uploads/avatars/';
$avatarFile = $row['image'] ?? '';
$hasAvatar  = ($avatarFile && $avatarFile !== 'RC.PNG' && file_exists($uploadDir . $avatarFile));

// avatar_path 返回以 / 开头的 URL，HTML 里可以直接用
$avatarPath = $hasAvatar ? '/uploads/avatars/' . $avatarFile : '/uploads/RC.PNG';
